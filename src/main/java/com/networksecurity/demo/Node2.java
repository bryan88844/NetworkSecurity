...
public class Node2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DatagramSocket node2Socket = new DatagramSocket(node2Port);
        byte[] receiveData = new byte[1024];
        DatagramPacket receivePacket = new DatagramPacket(receiveData, receiveData.length);

        while (true) {
            // Receive message from node 1 via router
            node2Socket.receive(receivePacket);
            ...
            // Send message to node 1 via router
