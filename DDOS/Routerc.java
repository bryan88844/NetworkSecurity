    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                byte[] message = new byte[] { buffer[8], buffer[9], buffer[10], buffer[11], buffer[12], buffer[13],
                        buffer[14],
                        buffer[15], buffer[16], buffer[17], buffer[18], buffer[19], buffer[20], buffer[21], buffer[22],
                        buffer[23] };
                ...
                if ((char) dstIP[2] == (char) '2') {
                    ...
                    try {
                        ...
                        byte[] frameData = { (byte) 0x00, (byte) 0x01, (byte) 0x02, (byte) 0x03, (byte) 0x04,
                                (byte) 0x05,
                        ...
                        System.out.println(
                                ...
                                (char) frameData[19] + "" + (char) frameData[20] + "" + (char) frameData[21] + ""
                                        + (char) frameData[22] + "|"

                                        + (char) frameData[23] + (char) frameData[24] + (char) frameData[25]
                                        + (char) frameData[26] + "|"
                                        ...
                                        + (char) frameData[32] + (char) frameData[33] + (char) frameData[34]
                                        + (char) frameData[35] + (char) frameData[36] + (char) frameData[37]
                                        + (char) frameData[38] + (char) frameData[39] + (char) frameData[40]
                                        + (char) frameData[41] + (char) frameData[42]);
                    ...
                    try {
                        ...
                        // Define the Ethernet frame data as a byte array
                        byte[] frameData = {(byte) 0x08, (byte) 0x09, (byte) 0x0a, (byte) 0x0b,
